...
cs_courses = {
    ...
    'COSC336': {'name': 'Software Engineering', 'credits': 3, 'prerequisites': ['ECCE230'], 'weight': 3, 'year': 3,'available_in' :  {'fall', 'spring'}},
    ...
    'ECCE434': {'name': 'Database Systems', 'credits': 3, 'prerequisites': ['COSC336'], 'weight': 3, 'year': 3,'available_in' : {'spring'}},
